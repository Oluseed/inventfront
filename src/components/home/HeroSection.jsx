    ...
    <section id="hero-section" className="bg-cover bg-center h-110 md:h-screen flex">
      <div className="text-white p-4 sm:mb-20 md:ml-10 flex flex-col gap-y-5 justify-end w-full mb-4">
        ...
        <div className="flex gap-x-2">
          <button className="flex bg-[#FF4C05] cursor-pointer hover:bg-[#c25124] px-2 place-content-center pt-2 gap-x-2 rounded font-montserrat text-[15px] text-white transition-all duration-300 group">
